...
public class Constants {
	...
	public static final String CHECK_BLOCK_TESTNET = "306027501040912039";
    public static final String CHECK_BLOCK = "8868708821622932189";
    //public static final int CHECK_HEIGHT = 150_000;
	public static final int CHECK_HEIGHT = 1;
    ...
    public static final String BURST_TICKER = "Rotura";
